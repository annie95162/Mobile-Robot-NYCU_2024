...
void setup() {
  ...
  output_msg.data_length = 4;  // Increase data length to accommodate ultrasonic sensor data
  output_msg.data = new int16_t[4];
...
void loop() {
  ...
  if (output_counter == OUTPUT_DELAY) {
    ...
    output_msg.data[3] = distance;  // Add ultrasonic distance to output message
